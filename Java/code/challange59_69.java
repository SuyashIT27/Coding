...
public class challange59_69 {
    ...
    public static void passwordCheaker(){
        ...
        System.out.println("Your password is correct Unlocking! alka verma yu are great");
    }
 ...
 public static void positiveSum(){
    ...
    //Using recursion
    public static void recursionFibo(){
        Scanner sc=new Scanner(System.in);
        int num =sc.nextInt();
        for(int i=0;i<num;i++){
//            int a=recursionFibo();
    ...
    //Q-69 using recursion find the palindrome of the number 
}
